...
export type CreateInvoiceFormInputsForPreviewType = {
...
export type CreateInvoiceFormInputsType = {
  client: {
    firstName: string;
    lastName: string;
    email: string;
...
export type CreateInvoiceFormType = {
  register: UseFormRegister<CreateInvoiceFormInputsType>;
  onSubmit: (
    e?: React.BaseSyntheticEvent<object, any, any> | undefined
  ) => Promise<void>;
  errors: FieldErrors<CreateInvoiceFormInputsType>;
  clearErrorOnChange: (name: FieldNames<CreateInvoiceFormInputsType>) => void;
  fields: Record<"id", string>[];
  append: UseFieldArrayAppend<FieldValues, "fixed">;
  remove: UseFieldArrayRemove;
  control: Control<CreateInvoiceFormInputsType, any>;
  handlePreviewValues: (dataName: string, dataValue: string | number, isJobDetails?: boolean | undefined, index?: number) => void
  removeFromPreviewValues: (indexToDelete: number) => void
